<template>
  <div class="onb-wrap">
    ...
    <!-- Модальное окно: Пользовательское соглашение (Редакция 2.0, вынесено в отдельный
         компонент — тот же текст переиспользуется в чекбоксе автопродления на PaymentScreen) -->
    <TermsAgreementModal v-model="agreementOpen" />
...
// Версия юридических документов — обновлять при выпуске новой редакции (Редакция 2.0,
// добавлены разделы про Тарифы/Абонентскую плату/Рекуррентные платежи — см. TermsAgreementModal.vue)
